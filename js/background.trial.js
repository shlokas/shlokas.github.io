...
(function() {
    ...
    function drawGears(canvas, rotation, targetFrame, resizing) {
        ...
        context.save();
        var resizedFrame = applyResizingBehavior(resizing, makeRect(10, 100, 582, 534), targetFrame);
        context.translate(resizedFrame.x, resizedFrame.y);
        context.scale(resizedFrame.w /190, resizedFrame.h / 180);
        ...
        roundedRect(context, -5.5, -41.5, 10, 20, 5);
        context.fillStyle = color;
        context.fill();
